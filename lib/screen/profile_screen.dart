            ...
            children: [
              Row(
                children: [
                  ...
                  const Text("user name and email")
                ],
              ),
              _commonCard(title: "My orders", desc: "Already have 10 orders"),
              _commonCard(title: " Shipping Addresses", desc: "03 Addresses"),
              _commonCard(title: "Payment Method", desc: "You have 2 cards",onTap: (){
                Get.toNamed(NameRoutes.paymentMethodScreen);
              }),
              _commonCard(title: "My  reviews", desc: "Reviews for 5 items"),
              _commonCard(
                  onTap: () {
